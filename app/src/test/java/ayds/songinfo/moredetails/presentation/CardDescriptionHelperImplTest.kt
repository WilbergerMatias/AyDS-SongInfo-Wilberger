...
class CardDescriptionHelperTest {
    ...
    fun `on local stored artist should return biography`() {
        val card = Card("artist", "biography", "url", "logoUrl", CardSource.WIKIPEDIA,true)
    ...
    fun `on no local stored artist should return biography`() {
        val card = Card("artist", "biography", "url", "logoUrl", CardSource.WIKIPEDIA,false)
    ...
    fun `should remove apostrophes`() {
        val card = Card("artist", "biography'n", "url", "logoUrl", CardSource.WIKIPEDIA, false)
    ...
    fun `should fix on double slash`() {
        val card = Card("artist", "biography\\n", "url", "logoUrl", CardSource.WIKIPEDIA, false)
    ...
    fun `should set artist name bold`() {
        val card = Card("artist", "biography artist", "url", "logoUrl", CardSource.WIKIPEDIA, false)
